...
;;;;; linum-mode
   `(linum ((t (:foreground ,zenburn-bg+05 :background ,zenburn-bg-05))))
;;;;; ruler-mode
...
;;;;; whitespace-mode
   `(whitespace-space ((t (:background ,zenburn-bg :foreground ,zenburn-bg-05))))
   `(whitespace-hspace ((t (:background ,zenburn-bg-05 :foreground ,zenburn-bg-05))))
   `(whitespace-tab ((t (:background ,zenburn-red-1))))
   `(whitespace-newline ((t (:foreground ,zenburn-bg-05))))
